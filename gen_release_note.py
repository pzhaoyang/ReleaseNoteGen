...
def RelaseNoteFrame(workbook):
    ...
    #add a sheet
    wsi = workbook.add_sheet(sheet1)

    # static style
    styleStaticName = xlwt.easyxf('font: name Times New Roman, height 240, color-index black, bold off; align: vert centre, horiz left')
...
if __name__=="__main__":
    ...
    WriteBugList(RelaseNoteFrame(wb))
    ## save boot to file
